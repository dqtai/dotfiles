...
alias nf='neofetch --source /home/user/.config/neofetch/cat.txt'
alias nft='neofetch --kitty /home/user/.config/qtile/background.png --size 260px --color_blocks off'
